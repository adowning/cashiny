...
import {
  ...
  TransactionType,
  // TransactionStatus,
  TransactionType as PrismaTransactionTypeEnum, // Alias if your shared type is also TransactionType
...
export async function getDepositConfiguration(
  userId: string
): Promise<DepositConfigurationResponse> {
...
export async function initializeDeposit(
  ...
  return prisma.$transaction(async (tx) => {
    ...
    let paymentResponse: Partial<InitializeDepositResponse> = {};
...
// --- Withdrawal Services ---
export async function getWithdrawalConfiguration(userId: string): Promise<WithdrawalConfig> {
  return {
    methods: [
