      ...
      4: [
        function (require, module, exports) {
          ...
          function processOptions(e) {
            ...
            e.staticRoot = '/public/nolimit';
            return (
              -1 === t.indexOf('.') && (t += '.nolimitcdn.com'),
              (e.cdn = e.cdn || CDN.replace('{ENV}', t)),
              (e.staticRoot = e.staticRoot || GAMES_URL.replace('{CDN}', e.cdn)),
              (e.playForFunCurrency = e.playForFunCurrency || e.currency),
              ('pe' !== e.language && 'cl' !== e.language) || (e.language = 'es'),
              e
            );
          }
                  ...
                  nolimit.info(t, function (i) {
                    if (i.error)
                      ...
                      if (gameName === 'FireInTheHole2')
                        i.staticRoot = `/public/nolimit/${gameName}/1.0.146`;
                      if (gameName === 'SanQuentin') i.staticRoot = `/public/nolimit/${gameName}`;
                      if (gameName === 'LandOfTheFree')
                        i.staticRoot = `/public/nolimit/${gameName}/1.0.157`;
                      if (gameName === 'TheCrypt')
                        i.staticRoot = `/public/nolimit/${gameName}/1.0.201`;
                      if (gameName === 'GaelicGold')
                        i.staticRoot = `/public/nolimit/${gameName}/1.4.8`;
