        ...
        gatherUserAgentInformation: function () {
            ...
            /Windows Phone/i.test(i)
                ...
                (Platform.isSafariBrowser =
                    /Safari/i.test(i) && !/Chrome/i.test(i)),
    ...
    (Core.Scaling = {
        ...
        calculateScale: function () {
            var e = Environment.determineResolution().resolution,
                t = Utils.Platform.getViewportSize(),
                i = t.height / e.height,
                n = t.width / e.width,
                o = Math.min(n, i);
            return parseFloat(o.toFixed(3));
        },
        ...
        centerGame: function (e) {
            var t,
                i = Environment.determineResolution(),
                n = i.resolution,
                o = Utils.Platform.getViewportSize();
            (t =
                Utils.Platform.isPortrait() && Platform.isMobileDevice
                    ? Math.round(i.portraitTopOffset * n.height * e)
                    : Math.round((o.height - n.height * e) / 2)),
                (this.viewport.style.top = t + "px"),
                (this.viewport.style.left =
                    Math.round((o.width - n.width * e) / 2) + "px"),
                window.scrollTo(0, 0);
        },
