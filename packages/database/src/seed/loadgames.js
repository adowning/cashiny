...
export default async function loadGames(prisma, key) {
  ...
  for (const _game of gamesData.default) {
    ...
    game.provider = GameProvider[game.developer] || GameProvider.INTERNAL;
    delete game.developer;
    // game.category = game.type || 'slots';
    game.category =
      GameCategory[game.type ? game.type.toUpperCase() : 'SLOTS'] || GameCategory.SLOTS;
