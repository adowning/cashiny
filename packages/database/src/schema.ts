...
//  * };
//  */
// type OverrideCommonFields<TTable> = Omit<TTable, 'id' | 'createdAt' | 'updatedAt' | 'deletedAt'> & {
//   id: string;
...
// type OverrideUsers = Omit<OverrideCommonFields<PUser>, 'role'> & {
//   role: Role;
// };
...
// // };
// //
// export type Kuser = OverrideUsers;
