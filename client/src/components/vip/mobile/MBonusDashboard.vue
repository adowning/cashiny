<script lang="ts" setup>
  ...
  const transactionTabs = ref<Array<string>>(['Promotions', 'VIP Bonus', 'Special Bonus'])
  ...
  >
    ...
    <div class="m-nav-drawer-content1">
      <div class="m-recharge-bonus-body">
        <VRow class="m-recharge-bonus-description">
          <VCol cols="9" class="m-recharge-col">
          ...
          <VCol cols="3" class="m-recharge-col m-recharge-col-img">
            <img
        ...
        <VRow style="margin-top: 16px; height: 40px; align-items: center" class="d-flex">
          <VCol cols="6" class="m-recharge-col m-recharge-col-btn1">
            <VBtn class="m-recharge-more-btn">
          ...
          <VCol cols="6" class="m-recharge-col m-recharge-col-btn2">
      ...
      <div class="m-recharge-bonus-body">
        <VRow class="m-deposit-bonus-description">
          <VCol cols="6" class="m-recharge-col">
          ...
          <VCol cols="6" class="m-recharge-col m-recharge-col-img">
