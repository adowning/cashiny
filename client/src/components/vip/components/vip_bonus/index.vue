  ...
  <div class="bonus-main">
    <div class="bonus-main-cashback">
      ...
      <div class="bonus-main-cashback-r">
        <span
          v-if="+vipBetawardList.now_cash_back > 0"
          @click="dispatchVipBetawardReceive({ type: 7 })"
          >{{ t('vip.vip_level_info.bonus.text_2') }}</span
        >
        <span v-else class="available-button">{{ t('vip.vip_level_info.bonus.text_2') }}</span>
      </div>
    </div>
    <div class="bonus-main-membership">
      ...
      <div class="bonus-main-membership-r">
        <span
          v-if="+vipCycleawardList.membership_day_gift > 0"
          @click="dispatchVipCycleawardReceive({ type: 2 })"
          >{{ t('vip.vip_level_info.bonus.text_2') }}</span
        >
        <span v-else class="available-button">{{ t('vip.vip_level_info.bonus.text_2') }}</span>
      </div>
    ...
    <div class="bonus-main-gift">
      <div class="bonus-main-gift-cycle">
        <div class="bonus-main-gift-cycle-t">
          ...
          <div class="bonus-main-gift-cycle-t-r">
            <span
              v-if="+vipCycleawardList.week_gift > 0"
              @click="dispatchVipCycleawardReceive({ type: 3 })"
              >{{ t('vip.vip_level_info.bonus.text_2') }}</span
            >
            <span v-else class="available-button">{{ t('vip.vip_level_info.bonus.text_2') }}</span>
          </div>
      ...
      <div class="bonus-main-gift-cycle">
        <div class="bonus-main-gift-cycle-t">
          ...
          <div class="bonus-main-gift-cycle-t-r">
            <span
              v-if="+vipCycleawardList.month_gift > 0"
              @click="dispatchVipCycleawardReceive({ type: 4 })"
              >{{ t('vip.vip_level_info.bonus.text_2') }}</span
            >
            <span v-else class="available-button">{{ t('vip.vip_level_info.bonus.text_2') }}</span>
          </div>
      ...
      <div class="bonus-main-gift-cycle">
        <div class="bonus-main-gift-cycle-t">
          ...
          <div class="bonus-main-gift-cycle-t-r">
            <span
              v-if="+vipLevelAward.uprank_gift > 0"
