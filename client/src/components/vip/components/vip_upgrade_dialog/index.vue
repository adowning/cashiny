...
<template>
  <VOverlay v-model="vipOverlay" contained class="align-center justify-center vip-position">
    <div class="vip-overlay">
      ...
      <div class="vip-overlay-level">
        <span
          >{{ t('vip.vip_level_info.upgrade.text_2') }} {{ vipLevelAward.old_level }} -
          {{ t('vip.vip_level_info.upgrade.text_2') }} {{ vipLevelAward.level }}</span
        >
      </div>
      ...
      <div class="vip-overlay-button">
        <VBtn color="success" @click="dispatchVipLevelAwardReceive({ type: 5 })">
